...
(defroutes https-routes
  (GET "/" [] (resp/file-response "app.html" {:root "resources/public"}))
...
(defroutes http-routes 
  ...
  (GET "/body-shops-st-louis/body-shop-clayton" request (site/clayton request))
  (GET "/body-shops-st-louis/body-shop-shrewsbury" request (site/shrewsbury request))
  (GET "/body-shops-st-louis/body-shop-chesterfield" request (site/chesterfield request))
  (GET "/body-shops-st-louis/body-shop-florissant" request (site/florissant request))
  (GET "/body-shops-little-rock" request (site/shops-lr request))
  (GET "/body-shops-little-rock/body-shop-west-little-rock" request (site/wlr request))
  (GET "/body-shops-little-rock/body-shop-north-little-rock" request (site/nlr request))
  (GET "/body-shops-little-rock/body-shop-cabot" request (site/cab request))
  ...
  (GET "/we-come-to-you" request (site/we-come-to-you request))
  (POST "/we-come-to-you" request (rfr/post-we-come-to-you request))
