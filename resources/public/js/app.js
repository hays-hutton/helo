...
var helo = angular.module('helo', ['helo.directives','ui']).
  config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider.when('/persons/:id', {templateUrl: 'partials/person.html', controller: PersonCtrl});
    $routeProvider.when('/notes', {templateUrl: 'partials/notes.html', controller: NotesCtrl});
    $routeProvider.when('/notes/:id', {templateUrl: 'partials/note.html', controller: NoteCtrl});
    $routeProvider.when('/agencies', {templateUrl: 'partials/agencies.html', controller: AgenciesCtrl});
    $routeProvider.when('/agency/:id', {templateUrl: 'partials/agency.html', controller: AgencyCtrl});
